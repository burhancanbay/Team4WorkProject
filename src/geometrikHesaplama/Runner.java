...
static	Scanner scan=new Scanner(System.in);
	...
	String s=	JOptionPane.showInputDialog("****Geometrik Hesaplama Programı****\n1.Cember\n2.Dikdortgen\n3.Kare\n4.Çıkış\n\nSeciminizi Yapın..:");
		...
		case "1":
			...
			JOptionPane.showMessageDialog(null, "Cemberin Cevresi ="+yeni.cevreHesabiCember()+"\n Cemberin Alanı: "+yeni.alanHesabiCember(),"Cember Sonucları",JOptionPane.PLAIN_MESSAGE);;
		...
		case "2":
			...
			JOptionPane.showMessageDialog(null, "Dikdörtgenin Cevresi ="+yeni1.cevreHesabidikdortgen()+"\nDikdörtgenin Alanı: "+yeni1.alanHesabidikdortgen(),"Dikdörtgen Sonucları",JOptionPane.PLAIN_MESSAGE);;
		...
		case "3":
			...
			JOptionPane.showMessageDialog(null, "Karenin Cevresi ="+kare.cevreHesabiKare()+"\nKarenin Alanı: "+kare.alanHesabiKare(),"Kare Sonucları",JOptionPane.PLAIN_MESSAGE);;
